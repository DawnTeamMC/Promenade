...
These biomes also feature a brand-new soundtrack: ["**Brise couleur pastel**" by **LudoCrypt**](@promenade:brise_couleur_pastel).

## Description
The sakura groves are heavily inspired by the cherry blossom trees in Japan. This biome was imagined before the vanilla cherry groves. They feature differently shaped trees and different generation features.

For example, sakura groves feature water pools with lily pads, bamboo patches and larger boulders of stone and calcite. The grass is a vibrant teal color.

## Features
### Sakura trees
2 variants of sakura trees generate in the groves:
...
The sakura wood set is a saturated brown color. It is a good alternative to the dark oak set when you want a more vibrant color.
...
However, you can also find pandas and foxes. There are also exclusive [Shiba Inu wolves](@promenade:wolf_variants) there.