...
<Callout type="info">
    You can edit the list of biomes in which this effect occur and the entities affected by it. See the [configuration
    page](../customization/configuration#freezing-snowfalls-configuration) for more details.
</Callout>