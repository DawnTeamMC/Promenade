...
public class DuckEntity extends AnimalEntity {
	...
	protected SoundEvent getAmbientSound() {
		return PromenadeEntities.DUCK_AMBIENT_SOUND;
	}

	@Override
	protected SoundEvent getHurtSound(DamageSource source) {
		return PromenadeEntities.DUCK_HURT_SOUND;
	}

	@Override
	protected SoundEvent getDeathSound() {
		return PromenadeEntities.DUCK_DEATH_SOUND;
	}

	@Override
	protected void playStepSound(BlockPos pos, BlockState state) {
		this.playSound(PromenadeEntities.DUCK_STEP_SOUND, 0.15F, 1.0F);
	}
