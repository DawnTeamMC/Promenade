...
public class SpikeFeatureConfig implements FeatureConfig {
	...
	public SpikeFeatureConfig(BlockState state, BlockState decorState, float decorChance, int baseHeight, int randomHeight, float baseRadius, float randomRadius, float baseYtheta, float randomYtheta, float baseZtheta, float randomZtheta, float yOffset) {
		this.state = state;
	...
	public SpikeFeatureConfig(BlockState state, int baseHeight, int randomHeight, float baseRadius, float randomRadius, float baseYtheta, float randomYtheta, float baseZtheta, float randomZtheta, float yOffset) {
		this(state, Blocks.AIR.getDefaultState(), 0f, baseHeight, randomHeight, baseRadius, randomRadius, baseYtheta, randomYtheta, baseZtheta, randomZtheta, yOffset);
	}

	public SpikeFeatureConfig setDecoration(BlockState state, float decorChance) {
		return new SpikeFeatureConfig(this.state, state, decorChance, this.baseHeight, this.randomHeight, this.baseRadius, this.randomRadius, this.baseYtheta, this.randomYtheta, this.baseZtheta, this.randomZtheta, this.yOffset);
	}
}