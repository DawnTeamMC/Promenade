...
public class GalleryBundle extends PromenadeBundle {
	...
	public static class Features {
		public static class Configured {
			public static final ConfiguredFeature<?, ?> TRITANOPIAN_GALLERY_GENERATION_1 = add(new ConfiguredFeatureCreator<>("huge_nether_mushroom/tritanopia/normal", Feature.RANDOM_BOOLEAN_SELECTOR.configure(new RandomBooleanFeatureConfig(HUGE_NETHER_MUSHROOM_PINK::withPlacement, HUGE_NETHER_MUSHROOM_CYAN::withPlacement))));
			public static final ConfiguredFeature<?, ?> TRITANOPIAN_GALLERY_GENERATION_2 = add(new ConfiguredFeatureCreator<>("huge_nether_mushroom/tritanopia/flat", Feature.RANDOM_BOOLEAN_SELECTOR.configure(new RandomBooleanFeatureConfig(HUGE_NETHER_MUSHROOM_PINK_FLAT::withPlacement, HUGE_NETHER_MUSHROOM_CYAN_FLAT::withPlacement))));
			public static final ConfiguredFeature<?, ?> TRITANOPIAN_GALLERY_GENERATION_3 = add(new ConfiguredFeatureCreator<>("huge_nether_mushroom/tritanopia/ceiling", Feature.RANDOM_BOOLEAN_SELECTOR.configure(new RandomBooleanFeatureConfig(HUGE_NETHER_MUSHROOM_PINK_UPSIDE::withPlacement, HUGE_NETHER_MUSHROOM_CYAN_UPSIDE::withPlacement))));
			public static final ConfiguredFeature<?, ?> TRITANOPIAN_GALLERY_GENERATION_4 = add(new ConfiguredFeatureCreator<>("huge_nether_mushroom/tritanopia/ceiling_flat", Feature.RANDOM_BOOLEAN_SELECTOR.configure(new RandomBooleanFeatureConfig(HUGE_NETHER_MUSHROOM_PINK_UPSIDE_FLAT::withPlacement, HUGE_NETHER_MUSHROOM_CYAN_UPSIDE_FLAT::withPlacement))));
		...
		public static class Placed {
			...
			public static final PlacedFeature TRITANOPIAN_GALLERY_GENERATION_1 = add(new PlacedFeatureCreator("huge_nether_mushroom/pink_cyan/normal", Configured.TRITANOPIAN_GALLERY_GENERATION_1.withPlacement(PLACEMENT_MODIFIERS)));
			public static final PlacedFeature TRITANOPIAN_GALLERY_GENERATION_2 = add(new PlacedFeatureCreator("huge_nether_mushroom/pink_cyan/flat", Configured.TRITANOPIAN_GALLERY_GENERATION_2.withPlacement(PLACEMENT_MODIFIERS)));
			public static final PlacedFeature TRITANOPIAN_GALLERY_GENERATION_3 = add(new PlacedFeatureCreator("huge_nether_mushroom/pink_cyan/ceiling", Configured.TRITANOPIAN_GALLERY_GENERATION_3.withPlacement(PLACEMENT_MODIFIERS)));
			public static final PlacedFeature TRITANOPIAN_GALLERY_GENERATION_4 = add(new PlacedFeatureCreator("huge_nether_mushroom/pink_cyan/ceiling_flat", Configured.TRITANOPIAN_GALLERY_GENERATION_4.withPlacement(PLACEMENT_MODIFIERS)));

			public static final PlacedFeature ACHROMATOPSIAN_GALLERY_GENERATION_1 = add(new PlacedFeatureCreator("huge_nether_mushroom/achromatopsian/normal", Configured.ACHROMATOPSIAN_GALLERY_GENERATION_1.withPlacement(PLACEMENT_MODIFIERS)));
			public static final PlacedFeature ACHROMATOPSIAN_GALLERY_GENERATION_2 = add(new PlacedFeatureCreator("huge_nether_mushroom/achromatopsian/flat", Configured.ACHROMATOPSIAN_GALLERY_GENERATION_2.withPlacement(PLACEMENT_MODIFIERS)));
			public static final PlacedFeature ACHROMATOPSIAN_GALLERY_GENERATION_3 = add(new PlacedFeatureCreator("huge_nether_mushroom/achromatopsian/ceiling", Configured.ACHROMATOPSIAN_GALLERY_GENERATION_3.withPlacement(PLACEMENT_MODIFIERS)));
			public static final PlacedFeature ACHROMATOPSIAN_GALLERY_GENERATION_4 = add(new PlacedFeatureCreator("huge_nether_mushroom/achromatopsian/ceiling_flat", Configured.ACHROMATOPSIAN_GALLERY_GENERATION_4.withPlacement(PLACEMENT_MODIFIERS)));

			public static final PlacedFeature PROTANOPIAN_GALLERY_GENERATION_1 = add(new PlacedFeatureCreator("huge_nether_mushroom/protanopian/normal", Configured.PROTANOPIAN_GALLERY_GENERATION_1.withPlacement(PLACEMENT_MODIFIERS)));
			public static final PlacedFeature PROTANOPIAN_GALLERY_GENERATION_2 = add(new PlacedFeatureCreator("huge_nether_mushroom/protanopian/flat", Configured.PROTANOPIAN_GALLERY_GENERATION_2.withPlacement(PLACEMENT_MODIFIERS)));
			public static final PlacedFeature PROTANOPIAN_GALLERY_GENERATION_3 = add(new PlacedFeatureCreator("huge_nether_mushroom/protanopian/ceiling", Configured.PROTANOPIAN_GALLERY_GENERATION_3.withPlacement(PLACEMENT_MODIFIERS)));
			public static final PlacedFeature PROTANOPIAN_GALLERY_GENERATION_4 = add(new PlacedFeatureCreator("huge_nether_mushroom/protanopian/ceiling_flat", Configured.PROTANOPIAN_GALLERY_GENERATION_4.withPlacement(PLACEMENT_MODIFIERS)));
		}
	}
	...
	public static class Biomes {
		...
		public static GenerationSettings.Builder composeTritanopianGalleryGenerationSettings() {
			return new GenerationSettings.Builder()
					.feature(GenerationStep.Feature.UNDERGROUND_DECORATION, MushroomBundle.Features.Placed.PINK_MUSHROOM_NETHER_PATCH)
					.feature(GenerationStep.Feature.UNDERGROUND_DECORATION, MushroomBundle.Features.Placed.CYAN_MUSHROOM_NETHER_PATCH)
					.feature(GenerationStep.Feature.VEGETAL_DECORATION, Features.Placed.TRITANOPIAN_GALLERY_GENERATION_1)
					.feature(GenerationStep.Feature.VEGETAL_DECORATION, Features.Placed.TRITANOPIAN_GALLERY_GENERATION_2)
					.feature(GenerationStep.Feature.VEGETAL_DECORATION, Features.Placed.TRITANOPIAN_GALLERY_GENERATION_3)
					.feature(GenerationStep.Feature.VEGETAL_DECORATION, Features.Placed.TRITANOPIAN_GALLERY_GENERATION_4);
		}

		public static GenerationSettings.Builder composeAchromatopsianGalleryGenerationSettings() {
			return new GenerationSettings.Builder()
					.feature(GenerationStep.Feature.UNDERGROUND_DECORATION, MushroomBundle.Features.Placed.WHITE_MUSHROOM_NETHER_PATCH)
					.feature(GenerationStep.Feature.UNDERGROUND_DECORATION, MushroomBundle.Features.Placed.LIGHT_GRAY_MUSHROOM_NETHER_PATCH)
					.feature(GenerationStep.Feature.UNDERGROUND_DECORATION, MushroomBundle.Features.Placed.GRAY_MUSHROOM_NETHER_PATCH)
					.feature(GenerationStep.Feature.UNDERGROUND_DECORATION, MushroomBundle.Features.Placed.BLACK_MUSHROOM_NETHER_PATCH)
					.feature(GenerationStep.Feature.VEGETAL_DECORATION, Features.Placed.ACHROMATOPSIAN_GALLERY_GENERATION_1)
					.feature(GenerationStep.Feature.VEGETAL_DECORATION, Features.Placed.ACHROMATOPSIAN_GALLERY_GENERATION_2)
					.feature(GenerationStep.Feature.VEGETAL_DECORATION, Features.Placed.ACHROMATOPSIAN_GALLERY_GENERATION_3)
					.feature(GenerationStep.Feature.VEGETAL_DECORATION, Features.Placed.ACHROMATOPSIAN_GALLERY_GENERATION_4);
		}
		...
		public static GenerationSettings.Builder composeProtanopianGalleryGenerationSettings() {
			return new GenerationSettings.Builder()
					...
					.feature(GenerationStep.Feature.UNDERGROUND_DECORATION, MushroomBundle.Features.Placed.YELLOW_MUSHROOM_NETHER_PATCH)
					.feature(GenerationStep.Feature.UNDERGROUND_DECORATION, MushroomBundle.Features.Placed.CYAN_MUSHROOM_NETHER_PATCH)
					.feature(GenerationStep.Feature.UNDERGROUND_DECORATION, MushroomBundle.Features.Placed.BLUE_MUSHROOM_NETHER_PATCH)
					.feature(GenerationStep.Feature.VEGETAL_DECORATION, Features.Placed.PROTANOPIAN_GALLERY_GENERATION_1)
					.feature(GenerationStep.Feature.VEGETAL_DECORATION, Features.Placed.PROTANOPIAN_GALLERY_GENERATION_2)
					.feature(GenerationStep.Feature.VEGETAL_DECORATION, Features.Placed.PROTANOPIAN_GALLERY_GENERATION_3)
					.feature(GenerationStep.Feature.VEGETAL_DECORATION, Features.Placed.PROTANOPIAN_GALLERY_GENERATION_4);
		}
		...
		public static Biome createGallery(GenerationSettings.Builder genBuilder) {
			SpawnSettings spawnSettings = new SpawnSettings.Builder()
					...
					.build();
			genBuilder.carver(GenerationStep.Carver.AIR, ConfiguredCarvers.NETHER_CAVE)
