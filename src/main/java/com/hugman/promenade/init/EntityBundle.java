...
public class EntityBundle extends PromenadeBundle {
	...
	public static final Item DUCK_SPAWN_EGG = add(new ItemCreator.Builder("duck_spawn_egg", settings -> new SpawnEggItem(EntityBundle.DUCK, 10592673, 15904341, settings), new Item.Settings().group(ItemGroup.MISC)).build());
	...
	public static final Item SUNKEN_SKELETON_SPAWN_EGG = add(new ItemCreator.Builder("sunken_skeleton_spawn_egg", settings -> new SpawnEggItem(EntityBundle.SUNKEN_SKELETON, 12233882, 6191682, settings), new Item.Settings().group(ItemGroup.MISC)).build());
