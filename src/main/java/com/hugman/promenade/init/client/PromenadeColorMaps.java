...
public class PromenadeColorMaps {
	...
	private static void registerBlockColors() {
		...
		ColorProviderRegistry.BLOCK.register((block, pos, world, layer) -> 16759362, PromenadeBlocks.AUTUMN_BIRCH_LEAVES, PromenadeBlocks.AUTUMN_BIRCH_LEAF_PILE);
	...
	private static void registerItemColors() {
		...
		ColorProviderRegistry.ITEM.register((item, layer) -> 16759362, PromenadeBlocks.AUTUMN_BIRCH_LEAVES, PromenadeBlocks.AUTUMN_BIRCH_LEAF_PILE);
