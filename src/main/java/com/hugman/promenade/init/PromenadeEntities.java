...
public class PromenadeEntities extends PromenadePack {
	...
	public static final Item DUCK_SPAWN_EGG = register(new ItemCreator.Builder("duck_spawn_egg", new SpawnEggItem(PromenadeEntities.DUCK, 10592673, 15904341, new Item.Settings().group(ItemGroup.MISC))));
