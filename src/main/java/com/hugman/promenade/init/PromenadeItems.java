...
public class PromenadeItems extends PromenadeBundle {
	public static final Item BLUEBERRIES = add(new ItemCreator.Builder("blueberries", settings -> new AliasedBlockItem(PromenadeBlocks.BLUEBERRY_BUSH, settings), new Item.Settings().group(ItemGroup.FOOD).food(PromenadeFoods.BLUEBERRIES)).compostingChance(0.30F).build());
