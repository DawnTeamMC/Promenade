...
public class PromenadeConfiguredFeatures extends PromenadePack {
	...
	public static final class Configs {
		public static final BlockPileFeatureConfig AMARANTH_ROOTS = new BlockPileFeatureConfig((new WeightedBlockStateProvider()).addState(PromenadeBlocks.DARK_AMARANTH_ROOTS.getDefaultState(), 80).addState(PromenadeBlocks.DARK_AMARANTH_WOOD.getFungus().getDefaultState(), 4));
	...
	public static final class States {
		...
		protected static final BlockState BLUNITE = PromenadeBlocks.BLUNITE.getBlock(DefaultBlockGetter.CUBE).getDefaultState();
		protected static final BlockState CARBONITE = PromenadeBlocks.CARBONITE.getBlock(DefaultBlockGetter.CUBE).getDefaultState();

		protected static final BlockState OAK_LOG = Blocks.OAK_LOG.getDefaultState();
		protected static final BlockState AUTUMN_OAK_LEAVES = PromenadeBlocks.AUTUMN_OAK_LEAVES.getLeaves().getDefaultState();
		protected static final BlockState AUTUMN_OAK_LEAF_PILE = PromenadeBlocks.AUTUMN_OAK_LEAVES.getLeafPile().getDefaultState();

		protected static final BlockState BIRCH_LOG = Blocks.BIRCH_LOG.getDefaultState();
		protected static final BlockState AUTUMN_BIRCH_LEAVES = PromenadeBlocks.AUTUMN_BIRCH_LEAVES.getLeaves().getDefaultState();
		protected static final BlockState AUTUMN_BIRCH_LEAF_PILE = PromenadeBlocks.AUTUMN_BIRCH_LEAVES.getLeafPile().getDefaultState();

		protected static final BlockState CHERRY_OAK_LOG = PromenadeBlocks.CHERRY_OAK_WOOD.getLog().getDefaultState();
		protected static final BlockState PINK_CHERRY_OAK_LEAVES = PromenadeBlocks.PINK_CHERRY_OAK_LEAVES.getLeaves().getDefaultState();
		protected static final BlockState PINK_CHERRY_OAK_LEAF_PILE = PromenadeBlocks.PINK_CHERRY_OAK_LEAVES.getLeafPile().getDefaultState();
		protected static final BlockState WHITE_CHERRY_OAK_LEAVES = PromenadeBlocks.WHITE_CHERRY_OAK_LEAVES.getLeaves().getDefaultState();
		protected static final BlockState WHITE_CHERRY_OAK_LEAF_PILE = PromenadeBlocks.WHITE_CHERRY_OAK_LEAVES.getLeafPile().getDefaultState();
