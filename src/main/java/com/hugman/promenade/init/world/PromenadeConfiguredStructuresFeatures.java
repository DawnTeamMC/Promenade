...
public class PromenadeConfiguredStructuresFeatures extends PromenadePack {
	public static final ConfiguredStructureFeature<?, ?> DARK_FOREST_WITCH_HUT = register(new ConfiguredStructureFeatureCreator.Builder<>("dark_forest_witch_hut", PromenadeStructureFeatures.WITCH_HUT.configure(DefaultFeatureConfig.DEFAULT)));
