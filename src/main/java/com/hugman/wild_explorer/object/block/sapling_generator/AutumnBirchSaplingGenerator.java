...
public class AutumnBirchSaplingGenerator extends SaplingGenerator {
	...
	protected ConfiguredFeature<TreeFeatureConfig, ?> createTreeFeature(Random random, boolean beeHive) {
		return random.nextInt(10) == 0 ? beeHive ? WEConfiguredFeatures.FANCY_AUTUMN_BIRCH_BEES_002 : WEConfiguredFeatures.FANCY_AUTUMN_BIRCH : beeHive ? WEConfiguredFeatures.AUTUMN_BIRCH_BEES_002 : WEConfiguredFeatures.AUTUMN_BIRCH;
	}
}