...
public class WEConfiguredFeatures extends WEPack {
	...
	public static final ConfiguredFeature<?, ?> ORE_BLUNITE = register("ore_blunite", ((Feature.ORE.configure(new OreFeatureConfig(OreFeatureConfig.Rules.BASE_STONE_OVERWORLD, States.BLUNITE, 33)).method_30377(80)).spreadHorizontally()).repeat(10));
	public static final ConfiguredFeature<?, ?> ORE_CARBONITE = register("ore_carbonite", ((Feature.ORE.configure(new OreFeatureConfig(OreFeatureConfig.Rules.BASE_STONE_OVERWORLD, States.CARBONITE, 33)).method_30377(80)).spreadHorizontally()).repeat(10));
	...
	public static final ConfiguredFeature<TreeFeatureConfig, ?> PALM = register("palm", DawnFeatures.SANDY_TREE.configure((new TreeFeatureConfig.Builder(new SimpleBlockStateProvider(States.PALM_LOG), new SimpleBlockStateProvider(States.PALM_LEAVES), new AcaciaFoliagePlacer(UniformIntDistribution.of(2), UniformIntDistribution.of(0)), new ForkingTrunkPlacer(16, 2, 2), new TwoLayersFeatureSize(1, 0, 1))).ignoreVines().build()));
	...
	public static final ConfiguredFeature<?, ?> TALL_AMARANTH_FUNGI = register("tall_amaranth_fungi", WEFeatures.TALL_HUGE_FUNGI.configure(new HugeFungusFeatureConfig(States.AMARANTH_DYLIUM, States.DARK_AMARANTH_STEM, States.AMARANTH_WART_BLOCK, States.COBWEB, false)).decorate(Decorator.COUNT_MULTILAYER.configure(new CountConfig(8))));
