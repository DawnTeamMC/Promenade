...
public class WEBiomePack extends WEPack {
	public static final Biome PUMPKIN_PASTURES = register(new BiomeCreator.Builder("pumpkin_pastures", WEBiomeCreator.createPumpkinPastures()).addToOverworldContinental(OverworldClimate.COOL, 1D));
	public static final Biome PINK_CHERRY_OAK_FOREST = register(new BiomeCreator.Builder("pink_cherry_oak_forest", WEBiomeCreator.createCherryOakForest(true)).addToOverworldContinental(OverworldClimate.COOL, 1D));
	public static final Biome WHITE_CHERRY_OAK_FOREST = register(new BiomeCreator.Builder("white_cherry_oak_forest", WEBiomeCreator.createCherryOakForest(false)).addToOverworldContinental(OverworldClimate.COOL, 1D));
