...
public class WEItemPack extends WEPack {
	public static final Item BLUEBERRIES = register(new ItemCreator.Builder("blueberries", new AliasedBlockItem(WEBlockPack.BLUEBERRY_BUSH, new Item.Settings().group(ItemGroup.FOOD).food(WEFood.BLUEBERRIES))).compostingChance(0.30F));
