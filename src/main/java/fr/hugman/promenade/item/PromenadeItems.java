...
public class PromenadeItems {
    ...
    public static final Item BANANA = register("banana", new Item.Properties().food(PromenadeFoodComponents.BANANA).compostable(ContextIntProviders.COMPOSTABLE_MEDIUM));
    public static final Item APRICOT = register("apricot", new Item.Properties().food(PromenadeFoodComponents.APRICOT).compostable(ContextIntProviders.COMPOSTABLE_MEDIUM));
    public static final Item MANGO = register("mango", new Item.Properties().food(PromenadeFoodComponents.MANGO).compostable(ContextIntProviders.COMPOSTABLE_MEDIUM));
