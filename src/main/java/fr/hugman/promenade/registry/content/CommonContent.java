...
import fr.hugman.promenade.gen.tree.foliage.CypressFoliagePlacer;
...
public class CommonContent {
	...
	public static final FoliagePlacerType<CypressFoliagePlacer> CYPRESS_FOLIAGE_PLACER = DawnFactory.foliagePlacer(CypressFoliagePlacer.CODEC);
	...
	public static void register(Registrar r) {
		...
		r.add("cypress", CYPRESS_FOLIAGE_PLACER);
