...
public class MapleContent {
    public static final BlockSetType BLOCK_SET_TYPE = BlockSetTypeBuilder.copyOf(BlockSetType.OAK).register(Promenade.id("maple"));
    public static final WoodType WOOD_TYPE = WoodTypeBuilder.copyOf(WoodType.OAK).register(Promenade.id("maple"), BLOCK_SET_TYPE);
