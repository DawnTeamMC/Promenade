...
public class TropicalContent {
    public static final BlockSetType BLOCK_SET_TYPE = BlockSetTypeBuilder.copyOf(BlockSetType.OAK).register(Promenade.id("palm"));
    public static final WoodType WOOD_TYPE = WoodTypeBuilder.copyOf(WoodType.OAK).register(Promenade.id("palm"), BLOCK_SET_TYPE);
    ...
    public static final Block PALM_HANGING_LEAVES = new HangingLeavesBlock(AbstractBlock.Settings.create()
            .item(new Item.Settings().compostingChance(0.3F))
            .mapColor(LEAVES_COLOR)
            .sounds(BlockSoundGroup.GRASS)
    ...
    public static final Block MOAI = new MoaiBlock(AbstractBlock.Settings.copy(Blocks.TUFF).mapColor(MapColor.TERRACOTTA_LIGHT_GRAY).item(new Item.Settings().equipmentSlot(stack -> EquipmentSlot.HEAD)));
