...
public class IgneousContent {
    public static final Block ASPHALT = new Block(AbstractBlock.Settings.copy(Blocks.ANDESITE).item().mapColor(MapColor.DEEPSLATE_GRAY).sounds(BlockSoundGroup.BASALT));
    ...
    public static final Block POLISHED_ASPHALT = new Block(AbstractBlock.Settings.copy(ASPHALT));
    ...
    public static final Block BLUNITE = new Block(AbstractBlock.Settings.copy(Blocks.ANDESITE).item().mapColor(MapColor.TERRACOTTA_CYAN).sounds(BlockSoundGroup.TUFF));
    ...
    public static final Block POLISHED_BLUNITE = new Block(AbstractBlock.Settings.copy(BLUNITE));
