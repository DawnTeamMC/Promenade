...
public class PromenadeFeatureConfigs {
    ...
    public static TreeFeature.Builder palm() {
        return new TreeFeature.Builder(
                ...
                .decorators(ImmutableList.of(new AttachedToLeavesDecorator(0.8f, 1, 0, BlockStateProvider.holderOf(PromenadeBlocks.PALM_HANGING_LEAVES), 2, List.of(Direction.DOWN))))
                .ignoreVines();
    }

    public static TreeFeature.Builder sakura(Block leaves, boolean fancy, Holder<BlockStateProvider> soilBeneathTree) {
        return new TreeFeature.Builder(
    ...
    public static TreeFeature.Builder maple(Block leaves, boolean fancy, Holder<BlockStateProvider> soilBeneathTree) {
        return new TreeFeature.Builder(
                BlockStateProvider.of(PromenadeBlocks.MAPLE_LOG.defaultBlockState().setValue(MapleLogBlock.NATURAL, true)),
    ...
    public static TreeFeature.Builder snowyMegaSpruce(Block leaves, Holder<BlockStateProvider> soilBeneathTree) {
        return new TreeFeature.Builder(
    ...
    public static HugeFungusFeature hugeDarkAmaranthFungus(boolean planted) {
        return new HugeFungusFeature(
