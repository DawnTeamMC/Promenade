...
public class PromenadeAdvancementProvider extends FabricAdvancementProvider {
    ...
    public void generateAdvancement(RegistryWrapper.WrapperLookup wrapperLookup, Consumer<AdvancementEntry> consumer) {
        ...
        Advancement.Builder.create()
                ...
                .criterion("harvest_maple_syrup", Criteria.ITEM_USED_ON_BLOCK.create(
                        new ItemCriterion.Conditions(
                                Optional.empty(),
                                Optional.of(
                                        LootContextPredicate.create(
                                                LocationCheckLootCondition.builder(
                                                        LocationPredicate.Builder.create().block(BlockPredicate.Builder.create().blocks(blocks, PromenadeBlocks.STRIPPED_MAPLE_LOG))
                                                ).build(),
                                                MatchToolLootCondition.builder(
                                                        ItemPredicate.Builder.create().items(items, Items.GLASS_BOTTLE)
                                                ).build()
                                ...
                                List.of(
                                        LootContextPredicate.create(
                                                EntityPropertiesLootCondition.builder(LootContext.EntityTarget.THIS, EntityPredicate.Builder.create()
                                                        .type(entities, PromenadeEntityTypes.SUNKEN)
                                                ).build(),
                                                InvertedLootCondition.builder(EntityPropertiesLootCondition.builder(LootContext.EntityTarget.THIS, EntityPredicate.Builder.create()
                                                        .location(LocationPredicate.Builder.create().fluid(FluidPredicate.Builder.create().tag(fluids.getOrThrow(FluidTags.WATER)))))
                                                ).build()
